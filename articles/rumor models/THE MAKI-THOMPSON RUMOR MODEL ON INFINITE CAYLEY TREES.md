...
4. **Конечный размер множества «затихателей» и «радиус» для $d=2$.**  
   ...
   5. **Число стирфлеров в конце.**  
	...
	$$\Pr(S_\infty=i)
=\frac{1}{9^i}\Bigl\{\,3\,\tfrac{G_{\,i-1}^{(i)}(0)}{(i-1)!}
+8\,\tfrac{G_{\,i-2}^{(i)}(0)}{(i-2)!}
+6\,\tfrac{G_{\,i-3}^{(i)}(0)}{(i-3)!}\Bigr\},\quad i\ge1.$$  
      где  
   ...
   6. **Радиус (максимальная глубина) распространения.**  
      Определим  
	$$R:=\max\{\,n\ge1\colon \exists\,x\text{ уровня }n,\ \exists\,t>0,\ \eta_t(x)=0\}.$$
